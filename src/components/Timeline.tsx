  ...
  const milestones = [
    {
      ...
      description: 'Focusing on high-level system architecture and mentoring cross-functional teams.',
      position: 'right',
      topPercent: 20,
    ...
    },
    {
      ...
      description: 'Developing complex React applications with a focus on motion and accessibility.',
      position: 'left',
      topPercent: 50,
    ...
    },
    {
      ...
      description: 'Building responsive websites and optimizing user experiences across platforms.',
      position: 'right',
      topPercent: 80,
