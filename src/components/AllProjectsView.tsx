          ...
          {filteredProjects.map((project) => (
            <motion.div key={project.id} variants={cardVariants}>
              <CometCard className="w-full h-full">
                <div className="w-full h-full bg-[#161622]/90 border border-white/10 rounded-2xl p-6 flex flex-col justify-between backdrop-blur-md preserve-3d group text-left min-h-[380px]">
                  <div>
                    {/* Header tags */}
